                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 pull-left">
                                Administrateur <input type="radio"  id="statut" name="statut" value="1" <?= 
                                ((isset($_POST['statut']) && $_POST['civilite'] == '1')) || !isset($_POST['statut']) ? 'checked' : '' ?>>
