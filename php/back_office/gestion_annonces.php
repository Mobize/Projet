...
$contenu .="<div class='col-md-12'><table class='table-striped table-categorie'>
            <tr>";

/* les en tetes */
$contenu .='<th class="th_categorie">Id annonce</th>';
$contenu .='<th class="th_categorie">Titre</th>';
$contenu .='<th class="th_categorie">Description courte</th>';
$contenu .='<th class="th_desc">Description longue</th>';
$contenu .='<th class="th_categorie">Prix</th>';
$contenu .='<th class="th_categorie">Photos</th>';
$contenu .='<th class="th_categorie">Pays</th>';
$contenu .='<th class="th_categorie">Ville</th>';
$contenu .='<th class="th_categorie">Adresse</th>';
$contenu .='<th class="th_categorie">Code postale</th>';
$contenu .='<th class="th_categorie">membre</th>';
$contenu .='<th class="th_categorie">Categorie</th>';
$contenu .='<th class="th_categorie">Date enregistrement</th>';
$contenu .='<th class="th_categorie">Actions</th>';
