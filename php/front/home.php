            ...
            <div class="col-md-8" id="bloc_liste_annonces">
               ...
               echo '<div class="row">';
                    echo'<div class="col-md-4">';
                            echo '<a href="php/front/fiche_annonce.php?id_annonce='.$ligne['id_annonce'].'"> <img class="img-thumbnail img-responsive affiche" src="'.$ligne['url'].'" alt="'.$ligne['titre'].'"></a>';
                    ...
                    echo '<div class="col-md-8 fiche_annonce"><div><h2 class="titre_fiche"><a href="php/front/fiche_annonce.php?id_annonce='.$ligne['id_annonce'].'">'.$ligne['titre'].'</a></h2></div>';
