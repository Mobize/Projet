...
$('#nav_qui_sommesnous').on('click',function(e){
    e.preventDefault();
    chargtContenuPHP(this,' http://localhost/annonceo/php/front/qui_sommesnous.php','#contenu_ppal');
});

/* Vers menu CONTACT */
/*$('#nav_contact').on('click',function(e){
    e.preventDefault();
    chargtContenuPHP(this,'http://localhost/annonceo/php/front/contact.php','#contenu_ppal');
});*/
...
/*$('#footer_mentions_legales').on('click',function(e){
    e.preventDefault();
    chargtContenuPHP(this,'http://localhost/annonceo/php/front/mentions_legales.php','#contenu_ppal');
});
/* Vers CGV */
/*$('#footer_cgv').on('click',function(e){
    e.preventDefault();
    chargtContenuPHP(this,'http://localhost/annonceo/php/front/cgv.php','#contenu_ppal');
});*/
